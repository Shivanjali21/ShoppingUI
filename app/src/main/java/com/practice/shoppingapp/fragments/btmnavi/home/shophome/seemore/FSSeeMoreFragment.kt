...
import com.practice.shoppingapp.databinding.FragmentFsSeeMoreBinding
import com.practice.shoppingapp.models.homeshop.fseemoredata.FSSeeMoreData

class FSSeeMoreFragment : Fragment(R.layout.fragment_fs_see_more) {

    private val binding : FragmentFsSeeMoreBinding by lazy {
        FragmentFsSeeMoreBinding.inflate(layoutInflater)
    }
        ...
        binding.apply {
           ivBackArrow.setOnClickListener {
            ...
            rvFSSeeMore.apply {
                ...
                fsSeeMoreAdapter.onItemClick = {
                   // val fsDetailData = FSSeeMoreData(it.fsMoreImg, it.fsMoreName, it.fsMorePrice, it.fsMoreCode, it.fsMoreSize, it.fsMoreColor)
//                    val action = FSSeeMoreFragmentDirections.actionSeeMoreFragmentToFSDetailFragment(fsDetailData)
//                    findNavController().navigate(action)
                }
            }
        }

        return binding.smFragRoot
    }
}